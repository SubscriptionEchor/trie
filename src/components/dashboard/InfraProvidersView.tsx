...
export function InfraProvidersView() {
  ...
  // useEffect(() => {
  //   (async () => {
  //     let infraData = await END_POINTS.providers({}) as any
  //     console.log(infraData, "infraData")
  //     if (infraData?.length) {
  //       // const enrichedData = infraData?.data.map((provider: any) => ({
  //       //   ...provider,
  //       //   // likes: provider.likes || '0', // Ensure 'likes' property exists
  //       //   // categories: provider.categories || [], // Ensure 'categories' property exists
  //       //   // id: provider.id || '', // Ensure 'id' property exists
  //       // }));
  //       setInfraProviders(infraData);
  //     }
  //   })()
  // }, [])
