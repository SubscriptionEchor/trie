...
// import ProviderDetails from '../ui/providerDetails';
...
//     return (
//         <div style={{ paddingTop: 120 }} className="pb-16 lg:px-8">
//             <h1 className="text-2xl font-medium mx-auto w-full md:w-[70%] text-gray-900 mb-6">Provider Details</h1>
//             {model?.metadata?.providers?.length > 0 ? <>
//                 {model?.metadata?.providers.map((provider: any, index: number) => (
//                     <ProviderDetails
//                         key={index}
...
//                 : <div className="w-full text-gray-900 text-left  font-semibold text-center  py-4">No Details Available</div>}
//         </div >
//     );
// };
...
//     providers: Provider[];
//     action?: string;
//     onSelectProvider: (args: { providerDid: string | undefined; hostingCost: number }) => void;
// }
                            ...
                            <div className="w-2/3 ms-3 border-s h-screen  rounded-xl p-8">
                                ...
                                <button
                                    onClick={() => onSelectProvider({
                                        providerDid: selectedProviderData.providerDid,
                                        hostingCost: selectedProviderData.hostingCost
                                    })}
                                    className="px-5 py-2.5 bg-primary text-white rounded-lg text-body-base font-medium hover:bg-primary-hover transition-all shadow-sm hover:shadow-md"
                                >
                                    Select Provider
                                </button>
                            )} */}
