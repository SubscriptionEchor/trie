...
export function Assets() {
  ...
  const handleCardClick = (model: any) => {
    ...
    // if (type == "infra") {
    //   navigate(`/dashboard/providerDetails`, {
    ...
    navigate(`/dashboard/${"assets"}/${slug}`, {
      state: { model: { ...model, type: "assets" } }
    });
  };
  ...
  console.log(paginatedAssets, "PAI")
  return (
            ...
            {isLoading ? (
              ...
              <div>
                ...
                {/* <p className="text-sm text-gray-500">
                  Access AI models, datasets, and infrastructure services
                </p> */}
              </div>
            )}
            ...
            paginatedAssets?.map((asset: any, index: number) => (
              ...
              >
                ...
                <div className="relative h-[225px] overflow-hidden bg-gray-50 flex-shrink-0 group-hover:after:absolute group-hover:after:inset-0 group-hover:after:bg-black/10 group-hover:after:transition-opacity">
                  <img
                    src={asset?.image || 'https://cdn.midjourney.com/d8fdb597-0d88-467d-8637-8022fb31dc1e/0_0.png'}
                ...
                <div className="p-5 flex-1 flex flex-col">
                  <div className="flex-1">
                    ...
                    {/* Categories */}
                    {/* {asset?.metadat?.type != "infra" && <div className="flex flex-wrap gap-2 mb-4">
