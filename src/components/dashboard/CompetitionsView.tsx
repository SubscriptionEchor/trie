...
export function CompetitionsView() {
  ...
  const competitions = [
    {
      id: 'trie-open-2025',
      title: 'Trie Open Hackathon 2025',
      subtitle: 'Building the Future of Decentralized AI',
      description: 'Join us for the Trie Open Hackathon, a global challenge to reimagine the future of AI through decentralization, verifiability and trust less collaboration.',
      dates: 'May 18–31, 2025',
      location: 'Virtual at testnet.trie.network/competitions/trieopen1',
      image: 'https://images.pexels.com/photos/7988079/pexels-photo-7988079.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1',
      themes: [
        'Decentralized AI – Build and deploy models on the Trie network',
        'Trust less Data Markets – Datasets with verifiable integrity',
        'Privacy – Advanced cryptography in AI workflows',
        'Infra Meets Intelligence – DePIN, tokenomics and decentralized inference',
        'AI Governance & Attribution – Solutions for ownership, licensing, and compliance'
      ],
      eligibility: [
        'Developers, researchers, data scientists and Web3 builders',
        'Solo hackers or teams (up to 5 members)',
        'Students, startups and open-source contributors welcome'
      ],
      prizes: [
        'Feature in Trie Marketplace',
        'Fast-track grant support',
        'Special awards for best use of Rubix, XellWallet, and privacy primitives'
      ],
      status: 'upcoming'
    },
    {
      id: 'dallas-ai-summer-2025',
                  ...
                  >
                    <div className="md:flex">
                      <div className="md:w-1/3 h-48 md:h-auto relative">
                        ...
                        />
                        <div className="absolute top-4 right-4 px-3 py-1 bg-[#0284a5] text-white text-xs font-bold rounded-full">
                      ...
                      <div className="p-6 md:w-2/3">
                        <div className="mb-4">
                          ...
                          <p className="text-[#0284a5] font-medium">{competition.subtitle}</p>
                        </div>
                        ...
                        {competition.id === 'trie-open-2025' && (
                          <div className="mb-4">
                            ...
                            <div className="mt-4 bg-gradient-to-r from-[#0284a5]/10 to-transparent p-4 rounded-lg border-l-4 border-[#0284a5]">
                              <h3 className="text-sm font-semibold text-gray-900 mb-2 flex items-center">
                                <Trophy className="w-4 h-4 mr-2 text-[#0284a5]" />
                                Rewards
                              </h3>
                        ...
                        {competition.id === 'dallas-ai-summer-2025' && (
                          <div className="mb-4">
                        ...
                        <div className="flex flex-wrap gap-2 mt-4">
                          {competition.id === 'trie-open-2025' && (
                            <button
                              ...
                              className="px-4 py-2 bg-[#0284a5] text-white rounded-lg hover:bg-[#026d8a] transition-colors text-sm font-medium flex items-center"
                            >
                          ...
                          {competition.id === 'dallas-ai-summer-2025' && (
                            <>
                              ...
                              <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="px-4 py-2 border border-[#0284a5] text-[#0284a5] rounded-lg hover:bg-[#0284a5]/5 transition-colors text-sm font-medium flex items-center"
                              >
                                View on Meetup
                                <ExternalLink className="w-3 h-3 ml-1" />
                              </a>
          ...
          <form onSubmit={handleSubmit} className="p-6">
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#0284a5] focus:border-transparent text-gray-900 bg-white"
            ...
            <div className="mt-6 flex justify-end gap-3">
              ...
              <button
                type="submit"
                disabled={registrationStatus === 'submitting'}
                className="px-4 py-2 text-sm font-medium text-white bg-[#0284a5] rounded-lg hover:bg-[#026d8a] disabled:opacity-50 flex items-center"
              >
